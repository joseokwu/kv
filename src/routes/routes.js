import { WithMentorMainLayout, WithMentorSecLayout, WithMentorRegistrationLayout } from "../mentorComponents";
...
import { WithInvestorSecLayout, WithInvestorRegistrationLayout, WithBoosterPartnerRegistrationLayout, WithMainInvestorLayout } from "../components";
...
import { WithStartupDashboardLayout, WithStartupRegistrationLayout, WithStartupRegisterLayout } from "../Startupcomponents";
...
import { WithAdminLayout, WithCriteriaEvaluationLayout } from "../adminComponents";
...
const routes = [
...

  {
    ...
    component: WithBoosterPartnerRegistrationLayout(BoosterPartnerRegistration),
    exact: true,
    protected: true,
    type: "booster",
  },
  ...
  // Admin E-acdemy is re-defined below: not sure how/why it's duplicated: online 2226: would be modifying here
  {
...

  {
    name: "admin User Management",
    path: "/admin/users/mentors/:id",
    component: WithAdminLayout(ViewMentor),
    exact: true,
    protected: true,
    type: "admin",
  },
...

  {
    name: "admin User Management",
    path: "/admin/users/investors/:id",
    component: WithAdminLayout(ViewInvestor),
    exact: true,
    protected: true,
    type: "admin",
  },

  {
    name: "admin User Management",
    path: "/admin/users/partners/:id",
    component: WithAdminLayout(ViewPartner),
    exact: true,
    protected: true,
    type: "admin",
  },
  ...
  // Admin E-acdemy is defined up: not sure how/why it's duplicated: online 1144: would be modifying up there
  {
    name: "admin E-academy",
    path: "/admin/academy",
    component: WithAdminLayout(AdminEAcademy),
