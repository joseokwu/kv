...
const dataForPlaceholder = [
  { name: 'Legend', color: '#50AEF4', size: 25 },
  { name: 'Legend', color: '#3AB011', size: 25 },
  { name: 'Legend', color: '#FF8E29', size: 25 },
  { name: 'Legend', color: '#890C85', size: 18 },
            ...
            data?.map((d, i) => {
              return (
                ...
                >
                  ...
                  <p className="legend-name mt-3">{d.name}</p>
                  <p className="ml-2 mt-3 percentage">{d.size}%</p>
                </div>
              )
            })}
        </section>
