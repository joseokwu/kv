                ...
                <article className="row">
                    <div className="col-lg-12">
                        <h1 className="profile-name">
                            {`${stateAuth?.investorData?.profile?.firstName} ${stateAuth?.investorData?.profile?.lastName}`}
                        </h1>
                    </div>
                    ...
                    <div className="row mb-3 pr-0" style={{ color: "#828282" }}>
                        ...
                        <div className="col-lg-4 text-right mb-2 pr-0">
                            <a
                                className="text-decoration-none"
                                style={{ color: "#828282" }}
                                href={`${data?.profile?.socialMedia?.profile}`}
                                target="_blank"
                            >
