        ...
        <FormCard>
          <div className="row">
            <section className="col-12 mb-4">
              ...
              <RowOption
                currentSelected={
                  stateAuth?.investorData?.personalDetail?.isLeadInvestor ===
                  true
                    ? 'yes'
                    : 'no'
                }
        ...
        <FormCard>
          <div className="row">
            <section className="col-12 mb-4">
              ...
              <RowOption
                currentSelected={
                  stateAuth?.investorData?.personalDetail?.mentorsStartups ===
                  true
                    ? 'yes'
                    : 'no'
                }
        ...
        <FormCard>
          <div className="row">
            <section className="col-12 mb-4">
              ...
              <RowOption
                currentSelected={
                  stateAuth?.investorData?.personalDetail?.investingFrom
                }
                getSelected={(value) => {
                  updateInvestorProfileData('personalDetail', {
                    investingFrom: value,
            ...
            <section className="col-12 mb-4">
              <TextField
                ...
                onChange={(e) =>
                  updateInvestorProfileData('personalDetail', {
                    numberOfInvestmentPerYear: e.target.value,
                  })
                }
              />
            </section>
