        ...
        <FormCard>
          ...
          <section className="mb-4">
            <TextareaCustom
              ...
              onKeyPress={letterOnly}
              placeholder={'Enter your terms and conditions (250 characters at most)'}
            />
          </section>
          ...
          <div className="row">
            <section className="col-md-6 mb-4">
              <Form.Item
                ...
                initialValue={
                  stateAuth?.partnerData?.offerings?.partnershipValidity
                }
                rules={[
                  {
                    required: true,
                    message: 'Please select a Partnership Validity!',
                  },
                ]}
              >
                <Select
          ...
          <div>
            ...
            <section className="free-choice">
              <button
                ...
                className={`yes-btn ${
                  stateAuth?.partnerData?.offerings?.freeCreditValue
                    ? 'active'
                    : ''
                } `}
              >
