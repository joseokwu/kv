...
export const CreateNewCriteria = () => {
  ...
  useEffect(() => {
    setCategories(adminState?.criteria);
        ...
        <article className={styles.wrap}>
          <section className={styles.page_desc}>
            ...
            <p className="mb-5">
              ...
              which you will use to analayze and evaluate the startups applying
              for the KV program. Please know that all question categories are
              prefilled and you are expected to adjust the questions base on
              your criteria.
            </p>
          </section>
          ...
          <section className={styles.form_area}>
            <h5>Categories</h5>
            <p>
              Create question categories to organize your decision criterias.
              You can set the amount of questions per category
            </p>

            <div>
              <img src={info} alt="info" />
              <p>
                You can set the amount of questions per category. All questions
                are rated on a scale of 0 to 5 and should total upto 150%
              </p>
            </div>
            ...
            <section className="mt-4">
              <p className="view-link" role="button" onClick={addCategoryInput}>
                Add Category +
              </p>
            </section>
