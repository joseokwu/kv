    ...
    () => [
      {
        ...
        action: (
          <Link to='application_mgt/kv_view/inProgress' className='view-link'>
            View
          </Link>
        ),
      },
      {
        ...
        action: (
          <Link to='application_mgt/kv_view/scheduled' className='view-link'>
            View
          </Link>
        ),
      },
      {
        ...
        action: (
          <Link to='application_mgt/kv_view/completed' className='view-link'>
            View
          </Link>
        ),
      },
