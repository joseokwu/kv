...
export const ViewCriteria = () => {
    ...
    const {
        adminState: { criteria, selectionProgress },
        setCriteria,
    ...
    const dataForCriteria = [
        {
            ...
            titleAndQuestion: [
                ...
                },
                {
                    title: "problem",
                    question:
                        "What is your initial impression about this idea ",
                },
                {
                    title: "Solution",
...

        {
            ...
            titleAndQuestion: [
                ...
                },
                {
                    title: "Winner",
                    question:
                        "What is your initial impression about this problem ",
                },
                {
                    title: "Wahala",
                    question:
    ...
    const dataForCategories = dataForCriteria.map((item) => item.category);
    ...
    return (
        <div className="bg-white p-5" style={{ minHeight: "93vh" }}>
            ...
            <section
                className="d-flex align-items-center justify-content-between mt-5 mb-4"
                css={css`
                    margin-left: 56px;
                    margin-right: 72px;
                `}
            >
                <h4 className="blue-title">Evaluation Criteria</h4>
                <div className="d-flex align-items-center space-out">
                    <Button
                        label="Edit"
                        variant="trans"
                        onClick={() => {
                            setSelectionProgressVal(20);
                            push("/admin/selection_process/new-criteria/12");
                        }}
                    />
                    <Button
                        label="Reuse"
            ...
            >
                <div className={styles.content}>
                    {dataForCriteria?.length > 0 &&
                    dataForCriteria[currentTab]?.titleAndQuestion?.length >
                        0 ? (
                        dataForCriteria[currentTab]?.titleAndQuestion?.map(
                            (tq, i) => {
                                return (
