  ...
  return (
    <form className="px-4">
      <section className="row">
        ...
        <div className="col-12 border-bottom pb-3 mb-4">
          <h5 className={styles}>Add Startups</h5>
        </div>

        <div className="col-12 mb-4">
          <p>
            Select startups that will participate in the acceleration program
          </p>
        </div>
        ...
        {addedStartups?.map((startup, i) => (
          <div className="col-12 mb-3" key={`added-startup-${i}`}>
            <StartupSearchItem image={startup?.image} name={startup?.name} />
          </div>
        ))}
