...
console.log(typeof dashInfo?.valuation?.amount !== undefined && convertToMillion(dashInfo?.valuation?.amount) )
    ...
    <div className="dashboardMain">
      ...
      <section className="container row my-5">
          ...
          /> 
            ...
            color={'#2E3192'}
            img={''}
            amount={typeof dashInfo?.valuation?.amount !== undefined && convertToMillion(dashInfo?.valuation?.amount)}
            time={dateFormat(dashInfo?.lastFund?.date, "fullDate")}
            className="col-3 col-6-md "
          /> 
