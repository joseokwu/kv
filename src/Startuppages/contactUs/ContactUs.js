...
export const StartupContactUs = () => {
  ...
  const onFinish = async (value) => {
    ...
    try {
      setLoading(true);
      const res = await sendSupport({ ...value });
      console.log(res);
      setLoading(false);
      if (res?.success) {
        toast.success('Message sent successfully');
        form.resetFields(['fullName', 'email', 'message']);
      } else {
      ...
      <section className='row mt-5'>
        <article className='col-lg-6 mt-2 mb-4'>
          <div className='d-flex align-items-center contact-us-info'>
            ...
            <a href='https://goo.gl/maps/r9J3b9dEGzVzUJ7i6' target='_blank'>
          ...
          <div className='d-flex align-items-center contact-us-info'>
            <img src={map} alt='location' />
            <a href='https://goo.gl/maps/3JJytmv6zeBqzLiR8' target='_blank'>
