  ...
  return (
    <div>
      ...
      >
        ...
        {state === 0 && (
          <Market
            data={stateAuth?.startupData?.businessCanvas?.market}
            handleChange={handleChange}
          />
        )}
        {state === 1 && (
          <Brand
            data={stateAuth?.startupData?.businessCanvas?.brand}
            handleChange={handleChange}
          />
        )}
        {state === 2 && (
          <BrandModeling
            data={stateAuth?.startupData?.businessCanvas?.businessModel}
            handleChange={handleChange}
          />
        )}
        {state === 3 && (
          <Plan
            data={stateAuth?.startupData?.businessCanvas?.plan}
            handleChange={handleChange}
          />
        )}

        <BusCanButton>
          <div className="my-3 d-flex justify-content-between p-3">
            <div>
              {state < 3 && (
                <button
                  className="can"
