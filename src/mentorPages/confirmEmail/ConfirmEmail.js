            ...
            case "startup":
                return (
                    <div>
                        <h2>
                            {" "}
                            Grow your business today with our accelerator
                            program.
                        </h2>
                        <span>
                            We are inviting startups to help them incubate and
                            accelerate their business ideas to funding.
                        </span>
                    </div>
                );
            case "investor":
                return (
                    <div>
                        ...
                        <span>
                            We are onboarding Investors to our startup eco
                            system for mutual benefits
                        </span>
                    </div>
                );
            case "mentor":
                return (
                    <div>
                        ...
                        <span>
                            We are onboarding Mentors to our startup eco system
                            for mutual benefits
                        </span>
                    </div>
                );
            case "boosterpartner":
                return (
                    <div>
                        <h2>
                            {" "}
                            Partner with startups. Become a Booster Partner{" "}
                        </h2>
                        <span>
                            We are onboarding Booster Partners to our startup
                            eco system for mutual benefits
                        </span>
                    </div>
                );
            default:
                return (
                    <h1>
                        We are onboarding Booster Partners to our startup eco
                        system for mutual benefits
                    </h1>
                );
        }
                        ...
                        <div className="gray_signIn confirm_email confirm_email_border">
                            <section className="text-center">
                                ...
                                <p>
                                    ...
                                    email. Didn’t receive the email?
                                </p>
                                <p
