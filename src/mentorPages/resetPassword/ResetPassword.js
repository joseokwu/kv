...
export const MentorResetPassword = ({ history }) => {
    ...
    const sendForgotPassword = async (value) => {
        try {
            ...
            setLoading(false);
            toast.error(
                err?.response?.data?.message ?? "Password reset unsuccessful"
            );
        }
    };
                ...
                <div className="row forgot-p">
                    <section className="col-lg-5 mx-1 forgot_illustration">
                        <div>
                            ...
                            <span>
                                Enter new password, different from the previous
                                used password
                            </span>
                        </div>
                    </section>
                        ...
                        <div className="gray_signIn">
                            ...
                            >
                                ...
                                <section className="mb-5">
                                    <i
                                        onClick={() => setDEye(!deye)}
                                        className={`cre-eye fa ${
                                            deye ? "fa-eye-slash" : "fa-eye"
                                        }`}
                                    ></i>
                                    <AuthPasswordField
                                        placeholder="Password must be at least 8 characters"
