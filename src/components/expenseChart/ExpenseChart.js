...
const dataForPlaceholder = [
  { name: "legend 1", color: "#50AEF4", size: 25 },
  { name: "legend 2", color: "#3AB011", size: 25 },
  { name: "legend 3", color: "#FF8E29", size: 25 },
  { name: "legend 4", color: "#890C85", size: 15 },
  { name: "others", color: "#C5C5C5", size: 10 },
];
