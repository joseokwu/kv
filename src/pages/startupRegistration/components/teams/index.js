...
import { HeaderTeam, ImageWrapper,
    InputWrapper, FormWrapper, BntWrap
} from './teams.styled';
      ...
      }
      {
       ...
       <form style={{marginBottom:'4rem'}} >
           <FormWrapper height='70%' >
            <div className='div' >
                <span>Founder</span>
                <p>A brief profile of your founders</p>
            </div>
    ...
    >
           ...
           <div className='div' >
             ...
             <div className='form-group my-2' >
                    <label>Invite a team member that can benefit from knight venture</label>
                    <input type='text' className='form-control my-2' placeholder='Enter Team member' />
                </div>
