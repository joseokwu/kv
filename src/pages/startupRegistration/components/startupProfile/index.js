...
import { HeaderStartup, ImageWrapper,
    InputWrapper, FormWrapper
} from './startup.styled';
            ...
            <FormWrapper>
               ...
               <div className='row'>
                ...
                <div className='form-group col-12'>
                    ...
                    value={formik.values.elevatorpitch} onChange={formik.handleChange} 
                     rows="7" cols="4" className='form-control' ></textarea>
                </div>
                <div className='form-group col-lg-6 col-12'>
                    <label>Startup *</label>
                    <input type='text' name='startupname' 
                    placeholder='Enter name per Registration'
                    value={formik.values.startupname} onChange={formik.handleChange} 
                ...
                <div className='form-group col-lg-6 col-12'>
                    ...
                    placeholder='eg; @576TYUKV'
                    value={formik.values.regNumber} onChange={formik.handleChange} 
                      className='form-control' />
                </div>
                ...
                <div className='form-group col-lg-6 col-12'>
                    ...
                    onChange={value => formik.setFieldValue('companySize', value.value)}
                     className='cust' />
                </div>
                ...
                <div className='form-group col-12'>
                    ...
                    value={formik.values.acceleratornames} onChange={formik.handleChange} 
                      className='form-control' />
                </div>
                    </div>
                ...
                <div className='form-group col-lg-6 col-12'>
                    ...
                    <input type='text' name='profileHandle' 
                    placeholder='Enter your startup profile handle'
                    value={formik.values.profileHandle} onChange={formik.handleChange} 
                      className='form-control' />
                </div>
                <div className='form-group col-lg-6 col-12'>
                    <label>Website *</label>
                    ...
                    value={formik.values.twitter} onChange={formik.handleChange} 
                      className='form-control' />
                        ...
                        <div className='d-flex my-4 justify-content-end'>
                            ...
                            <div className='mx-2' >
                                <CustomButton onClick={next}  background='#2E3192' >Next</CustomButton>
                            </div>
                        </div>
                    </FormWrapper>
