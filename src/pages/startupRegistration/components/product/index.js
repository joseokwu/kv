...
import { HeaderProduct, FormWrapper, VideoWrapper
   } from './product.styled';
        ...
        <div className='div'>
                    ...
                    <div className='row' >
                        <div className='form-group col-12'>
                            ...
                            <textarea cols='5' rows='7' classNam='form-control' placeholder='Enter Brief info about your product' ></textarea>
                        </div>
                        <div className='form-group col-12'>
                            <label>What makes your solution unique from others in the market? * 250 words</label>
                            <textarea cols='5' rows='7' classNam='form-control' placeholder='Enter your uniqueness ' ></textarea>
                        </div>
                        </div>
