...
import { Button, TextArea, Select } from "../../../../components/index";
...
const Interest = () => {
    ...
    return (
        <div className="mentor_details_form_wrap">
            ...
            <p>This will help us provide startups personalised for your preferences</p>
            ...
            <FormCard>
                <div className="row">
                    ...
                    <section className="col-md-12 mb-4">
                        <Select label={"What role(s) would you like to play within the Knight Ventures Network?"} />
                    </section>
                </div>
            </FormCard>
            ...
            <FormCard>
                <section className="col-md-12 mb-4">
                    <p className="gender_title mb-3">What mentor type would you prefer?</p>
                    <section className="gender_choice">
                        <button className="col-md-6 male_btn">Regular mentor - Dedicated office hours </button>
                        <button className="col-md-5 pl-2 female_btn">Directory listing - By approval </button>
                    </section>
                </section>
                ...
                <section className="col-md-12 mb-4">
                    <TextArea 
                        label={"In clear terms, please share your mentoring experience, and how that would come to bear as a Mentor in the Knight Ventures network?"}
                ...
                <div className="col-md-12 mb-4">
                    <p className="offer-text pt-2">Have you worked in growth marketing with Startups or Tech Companies?</p>
            ...
            <FormCard>
                <section className="upload_resume text-center mb-4">
                    <button><img className="mr-2" src={imageRep} alt={"upload_resume"}/> Upload Resume</button>
                </section>
